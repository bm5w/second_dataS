...
def test_insertion():
    ...
    assert insertion(input)[0] == [17, 20, 26, 31, 44, 54, 55, 71, 93]


def test_insertion_big():
    input = range(10000)
    assert insertion(input)[0] == range(10000)


def test_insertion_big_floats():
    input = [x*0.01 for x in range(0, 100)]
    assert insertion(input)[0] == [x*0.01 for x in range(0, 100)]
...
def test_insertion_big_increase_decrease():
    ...
    expected.sort()
    assert insertion(input)[0] == expected
...
def test_insertion_all_duplicates():
    input = [100]*20
    assert insertion(input)[0] == [100]*20